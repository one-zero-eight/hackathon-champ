...
function filterItemToFlat(i: LocationFilterItem): FlatLocation {
  return {
...
function LocBadge({ t }: { t: FlatLocation['t'] }) {
  return (
...
function compItems(a: LocationFilterItem, b: LocationFilterItem) {
