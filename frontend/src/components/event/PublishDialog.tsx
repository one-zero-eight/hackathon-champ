...
export function PublishDialog({ eventId }: { eventId: string }) {
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader className="text-left">
          <DialogTitle>Опубликовать мероприятие</DialogTitle>

          <DialogDescription>
            После вашего подтверждения мероприятие станет доступно для всех пользователей на сайте.
          </DialogDescription>
