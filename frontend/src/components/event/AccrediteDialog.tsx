...
export function AccrediteDialog({ eventId }: { eventId: string }) {
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader className="text-left">
          <DialogTitle>Подтвердить мероприятие</DialogTitle>

          <DialogDescription>
            После вашего подтверждения мероприятие станет доступно для всех пользователей.
          </DialogDescription>
